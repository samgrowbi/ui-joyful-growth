...
import { LED_CRYO_TREATMENT } from "@/config/treatments";
...
const LedCryoInner = () => {
  useEffect(() => { document.title = `${BRAND_NAME} | ${LED_CRYO_TREATMENT.label}`; }, []);
...
const LedCryo = () => (
  <TreatmentProvider treatment={LED_CRYO_TREATMENT}>
    <LedCryoInner />
  </TreatmentProvider>
);

export default LedCryo;
