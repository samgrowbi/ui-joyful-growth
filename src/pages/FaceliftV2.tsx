...
import { FACELIFT_V2_TREATMENT } from "@/config/treatments";
...
const FaceliftV2Inner = () => {
  useEffect(() => { document.title = `${BRAND_NAME} | ${FACELIFT_V2_TREATMENT.label}`; }, []);
...
const FaceliftV2 = () => (
  <TreatmentProvider treatment={FACELIFT_V2_TREATMENT}>
    <FaceliftV2Inner />
  </TreatmentProvider>
);

export default FaceliftV2;
